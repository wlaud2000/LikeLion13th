...
public enum OrderErrorCode implements BaseErrorCode {
    ...
    ORDER_UNAUTHORIZED(HttpStatus.FORBIDDEN, "ORDER403_1", "주문을 수정/취소할 권한이 없습니다."),
    ...
    ORDER_ALREADY_DELIVERED(HttpStatus.BAD_REQUEST, "ORDER400_4", "이미 배송 완료된 주문은 취소할 수 없습니다."),
    ;
